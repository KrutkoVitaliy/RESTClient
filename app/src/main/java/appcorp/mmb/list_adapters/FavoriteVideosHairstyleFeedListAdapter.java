...
public class FavoriteVideosHairstyleFeedListAdapter extends RecyclerView.Adapter<FavoriteVideosHairstyleFeedListAdapter.TapeViewHolder> {

    private List<VideoHairstyleDTO> videoHairstyleData;
    private Context context;
    boolean loaded = false;

    public FavoriteVideosHairstyleFeedListAdapter(List<VideoHairstyleDTO> videoHairstyleData, Context context) {
    ...
    public void onBindViewHolder(final TapeViewHolder holder, int position) {
        ...
        final VideoHairstyleDTO video = videoHairstyleData.get(position / 10);
    ...
    public int getItemCount() {
        return videoHairstyleData.size();
    }
