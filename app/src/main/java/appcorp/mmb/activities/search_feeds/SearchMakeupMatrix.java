...
public class SearchMakeupMatrix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FireAnal.sendString("Search manicure matrix", "Open", "Activity");
        ...
        adapter = new SearchMakeupMatrixAdapter(getApplicationContext());
        gridView.setAdapter(adapter);

        progressDialog = new ProgressDialog(this);
        progressDialog.setMessage(Intermediates.getInstance().convertToString(getApplicationContext(), R.string.loading));
        progressDialog.show();
        new Load(request, colors, eyeColor, difficult, occasion, run).execute();
    ...
    public class Load extends AsyncTask<Void, Void, String> {
        ...
        public Load(String request, ArrayList<String> colors, String eyeColor, String difficult, String occasion, int position) {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i = 0; i < items.length(); i++) {
                    ...
                    thumbs.add(item.getString("screen0"));
                }
